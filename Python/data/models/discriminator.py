...
from Python.data.SG2.torch_utils import misc
from .mapping_network import FullyConnectedLayer, ResidualBlock
from .vision_util import make_vit_backbone, forward_vit
from Python.data.SG2.training.diffaug import DiffAugment
...
class Discriminator(nn.Module):
    def __init__(self, c_dim: int, diffaug: bool = True, p_crop: float = 0.5, **kwargs):
        super().__init__()
        self.c_dim = c_dim
